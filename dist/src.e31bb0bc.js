...
document.addEventListener('DOMContentLoaded', function (event) {
  var links = document.querySelectorAll("#lnav > li > a");
  ...
  function notActive() {
    var links = document.querySelectorAll("#lnav li");
  ...
  window.addEventListener('scroll', debounce(function (e) {
    var headers = _toConsumableArray(document.querySelectorAll("h2"));

    var links = _toConsumableArray(document.querySelectorAll("#lnav li"));

    var tops = headers.map(function (el) {
    ...
    var _iterator3 = _createForOfIteratorHelper(tops.entries()),
        _step3;
